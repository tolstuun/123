...
- Caddy provides port 8080 reverse proxying because binding port 80 without sudo may conflict with host policy. HTTP Basic authentication is enforced by the application; health endpoints intentionally remain unauthenticated and non-sensitive.
