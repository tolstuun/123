...
- Caddy provides host port 8081 reverse proxying because existing host services occupy ports 80 and 8080. HTTP Basic authentication is enforced by the application; health endpoints intentionally remain unauthenticated and non-sensitive.
