import argparse, asyncio, csv, gzip, io, json, logging, random, time, zipfile
...
async def process_page(client,items,existing_ids,sample_cache):
    ...
    for item in items:
        ...
        try:
            ...
            archive=await client.archive(aid) if settings.fetch_analysis_archives else None
            sample_pk=ingest(detail,vtis,sample_cache[source_sample_id],archive)
